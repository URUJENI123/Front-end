  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Icon name="report-problem" size={80} color="#3F51B5" />
      ...
      <View style={styles.features}>
        <Card style={styles.featureCard}>
          <Card.Content style={styles.featureContent}>
            <Icon name="report" size={40} color="#4CAF50" />
        ...
        <Card style={styles.featureCard}>
          <Card.Content style={styles.featureContent}>
            <Icon name="track-changes" size={40} color="#FF9800" />
        ...
        <Card style={styles.featureCard}>
          <Card.Content style={styles.featureContent}>
            <Icon name="people" size={40} color="#9C27B0" />
